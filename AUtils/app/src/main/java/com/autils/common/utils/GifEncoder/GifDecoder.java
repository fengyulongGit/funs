package com.autils.common.utils.GifEncoder;
...
public class GifDecoder {
    ...
    public static GifDecoder decode(String path) throws Exception {
        GifDecoder glfDecoder = new GifDecoder();
        glfDecoder.read(new FileInputStream(path));
        return glfDecoder;
    }
