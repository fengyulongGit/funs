...
import com.autils.framework.ui.view.imageselector.adapter.FolderAdapter;
import com.autils.framework.ui.view.imageselector.adapter.ImageGridAdapter;
import com.autils.framework.ui.view.imageselector.bean.Folder;
import com.autils.framework.ui.view.imageselector.bean.Image;
import com.autils.framework.ui.view.imageselector.utils.FileUtils;
import com.autils.framework.ui.view.imageselector.utils.ScreenUtils;
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    if (Build.VERSION.SDK_INT >= 24) {
                        FileUtils.formatFileProviderPicIntent(getContext(), mTmpFile, intent);
                    } else {
